                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="bg-light p-4 h-100 rounded shadow-sm transition-hover">
                            ...
                            <p class="mb-0 text-muted">123 Route Kipopo , 75000 Lubumbashi, RD Congo</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="bg-light p-4 h-100 rounded shadow-sm transition-hover">
                    ...
                    <div class="col-md-6">
                        <div class="bg-light p-4 h-100 rounded shadow-sm transition-hover">
                            ...
                            <p class="mb-0 text-muted">+243 (0)97 23 45 67 89</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="bg-light p-4 h-100 rounded shadow-sm transition-hover">
    ...
    <div class="container px-lg-0">
        <div class="card border-0 shadow overflow-hidden">
            <div class="card-body p-0">
                <iframe class="w-100"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3812.881828!2d27.4389587!3d-11.6350883!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19723be8faca9df9%3A0x8af4e818750d180e!2sCostarita%20Hotel!5e0!3m2!1sfr!2scd!4v1703085163162!5m2!1sfr!2scd"
                    height="450"
                    style="border:0;"
                    allowfullscreen=""
                    loading="lazy">
