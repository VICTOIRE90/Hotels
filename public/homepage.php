        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <div class="d-flex align-items-center mb-4">
                    <a href="/public/about.php" class="btn btn-primary py-3 px-5">En savoir plus</a>
                    <a href="/public/contact.php" class="btn btn-outline-primary py-3 px-5 ms-3">Contactez-nous</a>
                </div>
            </div>
            <div class="col-lg-6">
